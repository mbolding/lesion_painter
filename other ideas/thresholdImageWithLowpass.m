function thresholdImageWithLowpass(varargin)
% thresholdImageWithLowPass('/Users/mbolding/Documents/MATLAB/analysis_for_collaborators/Andrabi_mouse_stroke_August_2024/mosaic_data/Jun_06_2024_M1_TIF_mosaic.tif')
    ...
    title('Lowpass Filtered Image with Red Threshold Overlay');
    ...
    function updateImage(~, ~)
        ...
        set(imgHandle, 'CData', filteredImg);
        
        % Update threshold overlay
        thresholdedImg = filteredImg > threshold;
